...
import com.example.sawit.ml.Model;
import com.example.sawit.ml.Model3;
import com.example.sawit.ml.Model5;
...
public class MainActivity extends AppCompatActivity {
    ...
    // Klasifikasi image (Costum Model)
    public void classifyImage(Bitmap image){
        try {
            ...
            //iterate over each pixel and extract R,G,B values. Add those values individuallymodel to the byte buffer
